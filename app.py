...
# 불용어 파일 호출
from dataset.stopword import stopword
# sentiment 모델 불러오기
...
def receive_data():
    ...
    for comment in parsed_data :
        ...
        # 가중합을 통한 최종 예측
        # 가중치 조정
        final_positive = (0.7 * s_sentiment_result[0] + 0.3 * ns_sentiment_result[0])  
        final_negative = (0.6 * s_sentiment_result[1] + 0.4 * ns_sentiment_result[1])
