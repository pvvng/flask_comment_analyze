...
from utils.my_functions.transform_keyword import transform_keyword
# 불용어 파일 호출
from utils.my_functions.stopword import stopword
# log 사용
import math
...
def process_received_data(parsed_data, v4_tokenizer, v4_model, okt, F):
    ...
    for comment in parsed_data :
        ...
        # 감정 분석
        sentiment_result = get_sentiment(text, v4_tokenizer, v4_model, F, 'v4')
        # 분석 결과 더하기 
