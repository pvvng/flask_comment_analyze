stopword = {
    '에 대해', '팔', '하기 때문에', '퉤', '잇따라', '하면서', '한적이있다', '그때', '입각하여', '시키다', '하면된다', '가령', '아', '와아', '자기', '와 같은 사람들', '인듯하다', '응당', '얼마큼', '얼마든지', '흥', 
    '반드시', '이로 인하여', '와르르', '총적으로보면', '관해서는', '일단', '붕붕', '관계없이', '의지하여', '이 정도의', '당신', '아이', '게다가', '당장', '자마자', '말하자면', '더라도', '어째서', '그래도', '한마디', 
    ...
    '하지마라', '만큼', '어디', '어느때', '비길수 없다', '연이서', '들', '할줄알다', '하면할수록', '진짜로', '자신', '따라', '솨', '로써', '것과 같이', '아무도', '좋아', '휴', '정도에 이르다', '하도다', '할만하다', '하구나', 
    ...
    '짐', '딮', '딥', '언', '안', '셈', '명', '득','뭔', '걸', '봉', '션', '이면', '내야', '순', '종', '빼', '만', '수', '이곳도', '요즘', '히히히', '줄',
}